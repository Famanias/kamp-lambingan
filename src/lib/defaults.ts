  ...
  packages: [
    {
      ...
      name: 'Weekday Escape',
      price: 3500,
      description: 'Private AC villa with river dipping pool access, ideal for couples.',
      featured: false,
    ...
    },
    {
      ...
      price: 5500,
      description: 'All-inclusive weekend glamping with activities, bonfire, and meals.',
      featured: true,
    ...
    },
    {
      ...
      name: 'Group Retreat',
      price: 15000,
      description: 'Perfect for team building or big families. Full day coverage and group activities.',
      featured: false,
