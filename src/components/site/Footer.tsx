        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-white/10">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              <Image src="/assets/logo.png" alt="Kamp Lambingan logo" width={40} height={40} />
              <span className="font-bold text-lg text-white">{content.siteTitle || 'Kamp Lambingan'}</span>
            </Link>
            <p className="text-white/60 text-sm leading-relaxed">
              {content.tagline || 'Your riverside camping escape in the heart of nature.'}
            </p>
          </div>
          ...
          {/* Connect */}
          <div>
            <h4 className="font-semibold text-white mb-4 uppercase tracking-wider text-xs">Connect</h4>
            <div className="flex gap-4">
              ...
              <a
                href="https://www.instagram.com/kamplambingan"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-primary hover:text-white transition-colors"
            ...
            {content.phone && (
              <p className="text-white/60 text-sm mt-4">
                <a href={`tel:${content.phone}`} className="hover:text-primary transition-colors">
                  {content.phone}
                </a>
              </p>
            )}
